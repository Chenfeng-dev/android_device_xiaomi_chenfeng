...
TARGET_KERNEL_SOURCE := kernel/xiaomi/chenfeng
...
BOARD_KERNEL_CMDLINE := \
    ...
    swinfo.fingerprint=chenfeng:14/V816.0.6.0.UNJINXM:user \
    mtdoops.fingerprint=chenfeng:14/V816.0.6.0.UNJINXM:user
